...
const AppRoutes = () => {
  ...
  const [triggerReferralModal, setTriggerReferralModal] = useState(false)
  ...
  // ========== NEW: Handle referral links WITHOUT redirect ==========
  useEffect(() => {
    ...
    if (refCode) {
      ...
      // Remove the ref parameter from URL without page reload (clean URL)
      const newUrl = window.location.pathname;
      window.history.replaceState({}, '', newUrl);
      
      // Trigger the referral modal to open (will be caught by Header)
      setTimeout(() => {
